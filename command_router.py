...
PARENT_HELP_SECTIONS = [
    ("心声", [
        ("好感", "核心数值（好感/亲密度/阶段/势头）"),
        ("阶段", "关系阶段详情"),
        ("画像", "自画像（8 维情感+行为+里程碑）"),
    ], "/心声 好感"),
    ("回忆", [
        ("趋势 天数", "近 N 天（默认14）情感趋势"),
        ("月报", "月报（净好感/情绪主调/里程碑）"),
    ], "/回忆 趋势 7"),
    ("纪念", [
        ("添加 日期 名称", "添加纪念日"),
    ...
    ("角色", [
        ...
        ("关系", "角色列表与解锁进度"),
        ("解锁 角色", "解锁内置关系角色"),
        ("关系切换 角色", "切换关系角色（一次锁定不可逆）"),
    ], "/角色 称谓 宝贝"),
    ("人格", [
        ("查看", "人格面板（20参数/稳定度/锁定），只读"),
    ], "/人格 查看"),
    ("知识", [
        ("查看", "知识库条目（按分类分组）"),
        ("添加 内容", "添加知识（分类可选）"),
    ...
    ("排行", [
        ("好感 n", "TOP n 好感榜（默认 10，最多 20）"),
        ("负好感 n", "BOTTOM n 负好感榜（默认 10，最多 20）"),
    ], "/排行 好感 5"),
]
